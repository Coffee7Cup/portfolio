...
<div class="project-card group relative overflow-hidden rounded-2xl border border-text-main/10 bg-text-main/5 p-6 transition-all duration-500 hover:border-accent/40 hover:shadow-[0_0_40px_rgba(255,0,0,0.08)] md:p-8">
	...
	<div class="mb-4 flex items-start justify-between">
		<h3
			class="font-stroke-display text-xl font-bold text-text-main transition-colors duration-300 group-hover:text-accent md:text-2xl"
		>
			{title}
		</h3>
	...
	<p class="mb-6 font-main text-sm leading-relaxed text-text-sub md:text-base">
		{description}
	</p>
